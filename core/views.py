...
# Agregamos UserSerializer a los imports
from .serializers import ArticleSerializer, ArticleCreateSerializer, CategorySerializer, UserSerializer
...
@api_view(['POST'])
@permission_classes([AllowAny]) # Permite que cualquiera se registre sin token
...
# ==========================================
#  2. ARTÍCULOS Y CATEGORÍAS (TU CÓDIGO ACTUAL)
# ==========================================
